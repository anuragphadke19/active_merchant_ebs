...
Then create an initializer, like initializers/payment.rb. Add the following lines:
  ...
  EBS_SECRET_KEY = 'your secret key'
...
This gem is heavily inspired by a similar integration done by Suman Debnath for CCavenue  @ https://github.com/meshbrain/active_merchant_ccavenue
